...
/**
*/
class LiNgAudioProcessor  : public AudioProcessor
{
public:
    //==============================================================================
    LiNgAudioProcessor();
...
private:
	...
	int p_flags;
	float p_wet, p_gain, p_t, p_p_g, p_ln;
	...
	float wet, gain, latt, lrel, natt, nrel, t, matt, mrel, p_g;
	bool ln;
	float *lvl, *env, *g;

    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (LiNgAudioProcessor)
};
